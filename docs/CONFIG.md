...
- `type` — discriminator (`structure`, `naming`, `presence`, `pair`, `frontmatter`, `spec-pair`, `import-boundary`, `import-cycle`, `call-obligation`, `no-passthrough`, `export-shape`, `frozen`, `mirror`).
